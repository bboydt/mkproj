...
echo "echo \"Project: \$project_name\" > \$target" >> build.sh
echo "echo \"Version: \$version_major.\$version_minor.\$version_build\" >> \$target" >> build.sh
echo "echo \"\$compiler \$flags -o \$target\"" >> build.sh
echo "" >> build.sh
